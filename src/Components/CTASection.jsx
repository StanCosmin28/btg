...
export default function CTASection() {
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 justify-between px-4 sm:px-5 text-white my-8 sm:my-12 md:my-16 lg:my-20 mx-4 sm:mx-8 md:mx-12 lg:mx-20 items-center z-[10] text-center">
        <h1 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl max-w-[380px] sm:max-w-[450px] md:max-w-[600px] lg:max-w-[750px] font-bold leading-tight">
          Ești gata să faci primul pas spre un <br /> proiect bine planificat?
        </h1>
