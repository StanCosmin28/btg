  ...
  return (
    <nav ref={navbarRef} className={navbarClasses}>
      <div className="max-w-screen-xxl flex flex-wrap items-center justify-between mx-auto p-4 xl:px-20">
        ...
        >
          <img src="/btg-logo-full.svg" className="h-12" alt="Fragar" />
          <span className="leading-none self-center text-xl font-bold whitespace-nowrap text-black transition-colors duration-300"></span>
        </Link>
